#!/usr/bin/env bash
# EvoMate Codex advisor injection hook.
# Reads Codex UserPromptSubmit JSON from stdin and returns hookSpecificOutput.additionalContext.
# Stdout must stay valid hook JSON; failures return {} and never block Codex.
set -u
